...
class NumberPicker extends StatelessWidget {
  ...
  static const double kDefaultItemExtent = 40.0;

  ///width of list view for normal number picker
  ///height of list view for horizontal number picker
  static const double kDefaultListViewCrossAxisSize = 80.0;
  ...
  NumberPicker.integer({
    ...
    this.decoration,
        ...
        selectedIntValue = initialValue,
        selectedDecimalValue = -1,
        listViewWidth = itemExtent * numberToDisplay,
        decimalPlaces = 0,
  ...
  Widget _integerListView(ThemeData themeData) {
    ...
    TextStyle selectedStyle =
        themeData.textTheme.headline.copyWith(color: Colors.white,fontSize: 65);

    var listItemCount =
        integerItemCount + numberToDisplay - 1; //3=>2, 7=>6, etc.
    var adaptedTextColor = Colors.white54;
                  ...
                  final TextStyle itemStyle =
                      value == selectedIntValue && highlightSelectedValue
                          ...
                          : defaultStyle.copyWith(
                              fontSize: selectedStyle.fontSize - 30,
